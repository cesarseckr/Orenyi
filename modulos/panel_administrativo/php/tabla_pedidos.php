	  	...
	  	<tbody>
	  		<?
        		...
        		foreach($rows as $row){
	        		...
	        		$ver='<a class="btn btn-secondary" id="ver_orden" id_orden="'.$id_orden.'" href="" target="_blank"><i class="fas fa-print"></i></a>';
